...
public class Solution implements Serializable
{
    public static void main(String[] args) {
        ...
        Solution loadedObject=new Solution(17);
        try
        {
            FileOutputStream fous=new FileOutputStream("C:\\Users\\Алина\\Desktop\\qwe.txt");
            FileInputStream ips=new FileInputStream("C:\\Users\\Алина\\Desktop\\qwe.txt");
