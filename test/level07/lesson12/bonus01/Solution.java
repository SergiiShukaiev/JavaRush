...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            ...
            if (agest.isEmpty()) break;
            int age=Integer.parseInt(agest);

            String weightst=reader.readLine();
            if (weightst.isEmpty()) break;
            int weight=Integer.parseInt(weightst);

            String teilLenghtst=reader.readLine();
            if (teilLenghtst.isEmpty()) break;
            int teilLenght=Integer.parseInt(teilLenghtst);

            Cat cat = new Cat(name, age, weight, teilLenght);
            CATS.add(cat);
        }
